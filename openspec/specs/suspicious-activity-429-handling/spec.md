# suspicious-activity-429-handling Specification

## Purpose

Defines differentiated handling for Kiro API 429 responses that indicate suspicious activity, applying a longer cooldown and failure counting to prevent continued use of flagged credentials.
